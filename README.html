...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17526187.svg)](https://doi.org/10.5281/zenodo.17526187)
...
## 🎯 Objetivo (TCDS)
Reducción de riesgo sísmico mediante predicción causal Σ–métrica (R(t), LI, RMSE_SL, κΣ) y protocolos operativos.

## 🧪 KPIs y criterios ΣMP
- LI ≥ 0.9, R > 0.95, RMSE_SL < 0.1, reproducibilidad ≥ 95%.

## 📬 Contacto e inversión
- geozunac3536@gmail.com — ROI estimado > 700 % (ver anexo económico).

## 🔖 Licencia
- CC0-1.0 (revisa la sección “Licencias” abajo si quieres **BY-NC-SA** + capa comercial).
## 12. Citación
Para citar este software en trabajos académicos:

**Carrasco Ozuna, G. (2025).** *Sistema Predictivo Sísmico TCDS — Análisis coherencial basado en el campo Σ*. Zenodo. DOI: [10.5281/zenodo.17526187](https://doi.org/10.5281/zenodo.17526187)
